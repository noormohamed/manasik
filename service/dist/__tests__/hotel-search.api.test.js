...
describe('Hotel Search API', () => {
    ...
    describe('GET /api/hotels - Search Hotels', () => {
         ...
         * }
         */
        it('should return all hotels without filters', () => __awaiter(void 0, void 0, void 0, function* () {
         ...
         */
        it('should search hotels by location', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
         ...
         */
        it('should filter hotels by guest capacity', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
                .query({
                guests: 4,
         ...
         */
        it('should filter hotels by minimum rating', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
                .query({ minRating: 4 })
                .expect(200);
         ...
         */
        it('should filter hotels by maximum price', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
                .query({ maxPrice: 300 })
                .expect(200);
         ...
         */
        it('should handle multiple filters combined', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
                .query({
                city: 'Makkah',
         ...
         */
        it('should return hotels with correct format', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels')
                .query({ limit: 1 })
                .expect(200);
    ...
    describe('GET /api/hotels/listings - User Managed Hotels', () => {
         ...
         * }
         */
        it('should return hotels managed by the authenticated user', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
         ...
         */
        it('should include rooms when requested', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels/listings')
                .set('Authorization', `Bearer ${authToken}`)
         ...
         */
        it('should return hotels with management info', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get('/api/hotels/listings')
                .set('Authorization', `Bearer ${authToken}`)
                .expect(200);
    ...
    describe('GET /api/hotels/:id/rooms - Hotel Rooms', () => {
         ...
         * }
         */
        it('should return rooms for a hotel (public access)', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
         ...
         */
        it('should indicate if user manages the hotel', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get(`/api/hotels/${testHotelId}/rooms`)
                .set('Authorization', `Bearer ${authToken}`)
                .expect(200);
         ...
         */
        it('should return rooms with correct format', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app.callback())
                .get(`/api/hotels/${testHotelId}/rooms`)
                .expect(200);
