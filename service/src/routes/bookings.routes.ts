  ...
  try {
    ...
    const [bookings] = await pool.query<any>(
      `SELECT 
        ...
        b.broker_fee as brokerFee,
        b.broker_notes as brokerNotes,
        b.manasik_fee_percent as manasikFeePercent,
    ...
    ctx.body = {
      booking: {
        ...
        brokerFee: booking.brokerFee ? parseFloat(booking.brokerFee) : 0,
        brokerNotes: booking.brokerNotes || null,
        manasikFeePercent: booking.manasikFeePercent ? parseFloat(booking.manasikFeePercent) : 0,
        manasikFeeAmount: booking.manasikFeeAmount ? parseFloat(booking.manasikFeeAmount) : 0,
